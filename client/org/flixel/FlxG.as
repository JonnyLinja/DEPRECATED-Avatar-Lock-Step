/**
 * This is modified so pause is completely removed
 * Start by commenting out the pause import in FlxGame
 * then comment everything else that causes compile errors
 * 
 * This is also modified to expose internal functions
 * Add public and commented out internal
 * This was done so Avatar.as could override FlxGame's update function
 * That way, code can be more separated out
...
package org.flixel
{
	...
	public class FlxG
	{
		...
		*/
		 ...
		 */
		public static /*internal*/ function updateSounds():void
		{
			if((music != null) && music.active)
				music.update();
			var s:FlxSound;
		...
		*/
		 ...
		 */
		public static /*internal*/ function updateInput():void
		{
			keys.update();

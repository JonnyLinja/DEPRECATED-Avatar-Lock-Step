 ...
 * Start by commenting out the pause import
 * then comment everything else that causes compile errors
 * 
 * This is also modified to expose internal variables
...
package org.flixel
{
	...
	public class FlxGame extends Sprite
	{
		...
		//basic display stuff
		public /*internal*/ var _state:FlxState;
